    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start mb-8">
        ...
        <div className="text-center md:text-left md:flex-1">
          <h2 className="text-3xl font-bold mb-3 relative inline-block group">
...
>
  ...
  "
      ...
      >
        <button className="flex-1 px-5 py-4 bg-rose-500 text-white rounded-xl hover:bg-rose-600 transition-all duration-300 flex items-center justify-center transform hover:-translate-y-1 active:translate-y-0 active:scale-95 shadow-md hover:shadow-xl">
